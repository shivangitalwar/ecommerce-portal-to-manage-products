...
t.prototype.j=!1;t.prototype.dispose=function(){this.j||(this.j=!0,this.s())};
t.prototype.s=function(){if(this.o)for(;this.o.length;)this.o.shift()()};var u=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};r("yt.config_",u);function w(a,b){return a in u?u[a]:b}
...
function D(a){a=void 0===a?{}:a;t.call(this);this.a=[];this.a[8]=[];this.a[4]=[];this.a[3]=[];this.a[2]=[];this.a[1]=[];this.a[0]=[];this.f=0;this.I=a.timeout||1;this.c={};this.i=C;this.u=this.b=this.h=0;this.v=this.g=!1;this.l=[];this.B=p(this.M,this);this.H=p(this.O,this);this.D=p(this.K,this);this.F=p(this.L,this);this.G=p(this.N,this);this.m=this.w=!1;var b;if(b=!!window.requestIdleCallback)b=y("disable_scheduler_requestIdleCallback"),b=!("string"==typeof b&&"false"===b?0:b);this.C=b;(this.A=
...
function I(a,b,c,e){++a.u;if(10==c)return G(a,b),a.u;var d=a.u;a.c[d]=b;a.g&&!e?a.l.push({id:d,priority:c}):(a.a[c].push(d),a.v||a.g||(0!=a.b&&J(a)!=a.h&&K(a),a.start()));return d}
function L(a){a.l.length=0;for(var b=4;0<=b;b--)a.a[b].length=0;a.a[8].length=0;a.c={};K(a)}
function J(a){if(a.a[8].length)return a.m?4:3;for(var b=4;b>=a.f;b--)if(0<a.a[b].length)return 0<b?!document.hidden&&a.A?3:2:1;return 0}
...
f=D.prototype;f.L=function(a){var b=void 0;a&&(b=a.timeRemaining());this.w=!0;N(this,b);this.w=!1};
f.O=function(){N(this)};
f.K=function(){O(this)};
...
f.s=function(){L(this);K(this);this.A&&document.removeEventListener("visibilitychange",this.B);t.prototype.s.call(this)};var Q=n("yt.scheduler.instance.timerIdMap_")||{},R=0,S=0;function T(){var a=n("ytglobal.schedulerInstanceInstance_");if(!a||a.j)a=new D(w("scheduler",void 0)||{}),r("ytglobal.schedulerInstanceInstance_",a);return a}
...
function la(){var a=T();K(a);a.v=!0;window.clearTimeout(R);R=window.setTimeout(ka,x())}
